function psdSequence = PsdSequence(independentSequence, noiseEigenspaceMatrix)
    ...
    for n = 1:vectorNumber
        % squarenormSequence = squarenormSequence + steeringVectorSequence' * noiseEigenspaceMatrix * noiseEigenspaceMatrix' * steeringVectorSequence;
        squarenormSequence = squarenormSequence + abs(steeringVectorSequence' * noiseEigenspaceMatrix(:, n)).^2;
    end
